...
> У "Enhanced Camera" есть проблемы с "Dovahkiin Relaxes Too", но в основном конфликтов с модами на анимации не имеет, т.к. является SKSE-плагином и считается более безопасным.
